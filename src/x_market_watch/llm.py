...
class LLMAnalyzer:
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "与股票或金融市场分析无关的内容，只保留对投资决策有实际帮助的"
                        "股票、公司、行业、宏观、政策、财报、估值、交易逻辑、新闻解读、"
                        "催化剂、风险和市场观点。"
    ...
    def _build_prompt(posts: list[Post]) -> str:
        ...
        return (
            ...
            "核心目标是剔除所有与股票、公司、行业、金融市场分析无关的内容。"
            "优先保留这些内容："
            ...
            "没有新增观点的新闻标题、无法验证的传言、政治/社会/科技泛资讯、"
            "与股票或金融市场分析无关的内容。"
            "importance 用 1-5 分："
            ...
            "title 请写成一句中文短标题，尽量包含作者或观点主体，例如“Serenity 认为"
            "Sivers 是光子学瓶颈”，不要使用泛泛标题。"
            "summary_zh 是“内容”字段，请详细翻译并压缩推文核心内容，保留关键公司、"
            "股票代码、数据、因果关系和作者观点。"
            "why_it_matters_zh 请详细说明它对投资判断、基本面、估值、催化剂、风险或"
            "市场预期有什么意义。"
            "tags 要详细，至少包含主要板块方向和细分内容，例如“半导体”“光模块”；"
            "也可以加入“个股”“基本面”“财报”“宏观”等。每个 tag 不要带 #。"
            "返回 JSON 格式："
